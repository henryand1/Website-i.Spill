          ...
          <div class="row" style="justify-content: space-between">
            <div class="col-md-3">
                <div href="#" class="card card-product-grid" background="#FF85A2">
                  <a href="{{url('/v_userfoundation')}}" class="#"> <img src="img/MAYBELLINE.PNG" style="width: 250px; margin-top:5px; margin-left:5px"> </a>
                    <a href="{{url('/v_userfoundation')}}" class="img-wrap"> <img src="img/maybelline foundi.png"> </a>
                    <figcaption class="info-wrap" style="background: white">
                      <a href="{{url('/v_userfoundation')}}" class="#"> <img src="img/teks foundi.PNG" style="width: 250px; margin-top:-5px; margin-left:-12px"> </a>
                    </figcaption>
                </div>
            </div> <!-- col.// -->
            <div class="col-md-3">
                <div href="#" class="card card-product-grid">
                  <a href="#" class="#"> <img src="img/DEAR ME.PNG" style="width: 250px; margin-top:5px; margin-left:5px"> </a>
                    <a href="#" class="img-wrap"> <img src="img/loreal mascara.png"> </a>
            ...
            <div class="col-md-3">
                <div href="#" class="card card-product-grid">
                  <a href="#" class="#"> <img src="img/BLP.PNG" style="width: 250px; margin-top:5px; margin-left:5px"> </a>
                    <a href="#" class="img-wrap"> <img src="img/makeover1.png"> </a>
                    <figcaption class="info-wrap">
